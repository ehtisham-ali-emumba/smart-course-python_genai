...
Add to `docker-compose.yml` for every service that produces or consumes Kafka messages — user-service, course-service, notification-service, core-event-bridge:
