...
class CourseContentService:
    ...
    async def get_content(self, course_id: _uuid.UUID) -> dict[str, Any] | None:
    ...
    async def create_or_update_content(
        self, course_id: _uuid.UUID, data: CourseContentCreate
    ) -> dict[str, Any]:
    ...
    async def add_module(self, course_id: _uuid.UUID, data: ModuleCreate) -> dict[str, Any] | None:
    ...
    async def add_lesson(
        self, course_id: _uuid.UUID, module_id: str, data: LessonCreate
    ) -> dict[str, Any] | None:
    ...
    async def update_module(
        self, course_id: _uuid.UUID, module_id: str, data: ModuleUpdate
    ) -> dict[str, Any] | None:
    ...
    async def update_lesson(
        self, course_id: _uuid.UUID, module_id: str, lesson_id: str, data: LessonUpdate
    ) -> dict[str, Any] | None:
    ...
    async def delete_module(self, course_id: _uuid.UUID, module_id: str) -> dict[str, Any] | None:
    ...
    async def delete_lesson(
        ...
        doc = await self.content_repo.soft_delete_lesson(course_id, module_id, lesson_id)
        if doc:
            doc.pop("_id", None)
            await cache_delete(f"course:content:{course_id}")
        return doc
    ...
    async def add_resource(
        self, course_id: _uuid.UUID, module_id: str, lesson_id: str, data: MediaResourceCreate
    ) -> dict[str, Any] | None:
    ...
    async def delete_content(self, course_id: _uuid.UUID) -> bool:
